...
import ArchivesForge from "@/components/archives/ArchivesForge"; // Nouveau composant
  ...
  return (
    <>
      ...
      >
        ...
        {mode === "officialDuel" && <OfficialDuelMode onBack={() => setMode(null)} />}
        {mode === "handicap" && <HandicapMode onBack={() => setMode(null)} />}
        {mode === "tournament" && <TournamentMode onBack={() => setMode(null)} />}
        {mode === "highlander" && <HighlanderMode onBack={() => setMode(null)} />}
        {mode === "battleRoyale" && <BattleRoyaleMode onBack={() => setMode(null)} />}
        {mode === "officialRules" && <OfficialRules onBack={() => setMode(null)} />}
        
        {/* Utilisation du nouveau composant ArchivesForge */}
        {mode === "archives" && (
  <ArchivesForge onBack={() => setMode(null)} />
)}
      </div>
    </>
  );
